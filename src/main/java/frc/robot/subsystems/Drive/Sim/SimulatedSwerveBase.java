...
public class SimulatedSwerveBase extends SwerveDrivetrain<TalonFX, TalonFX, CANcoder>{
    public SimulatedSwerveBase(SwerveDrivetrainConstants drivetrainConstants, SwerveModuleConstants<?, ?, ?>... modules) {
