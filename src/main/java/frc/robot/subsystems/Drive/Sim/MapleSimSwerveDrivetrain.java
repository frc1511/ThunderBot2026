    ...
    public MapleSimSwerveDrivetrain(
        ...
        DriveTrainSimulationConfig simulationConfig = DriveTrainSimulationConfig.Default()
                ...
                .withSwerveModule(new SwerveModuleSimulationConfig(
                        driveMotorModel,
                        steerMotorModel,
                        moduleConstants.get(0).DriveMotorGearRatio,
                        moduleConstants.get(0).SteerMotorGearRatio,
                        Volts.of(moduleConstants.get(0).DriveFrictionVoltage),
                        Volts.of(moduleConstants.get(0).SteerFrictionVoltage),
                        Meters.of(moduleConstants.get(0).WheelRadius),
                        KilogramSquareMeters.of(moduleConstants.get(0).SteerInertia),
                        wheelCOF));
        ...
        for (int i = 0; i < this.simModules.length; i++)
            simModules[i] = new SimSwerveModule(moduleConstants.get(0), moduleSimulations[i], modules[i]);
